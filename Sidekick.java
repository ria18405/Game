...
//            clonedobj_3.attack_value=this.attack_value;
        ...
        for(int i=0;i<this.clonedspecies.size();i++){
            mon.sethp(mon.gethp()-this.clonedspecies.get(i).attack_value);
            System.out.println("Sidekick attacked and inflicted "+this.clonedspecies.get(i).attack_value+ "damage to the monster.");
            System.out.println("Sidekick Hp:"+this.clonedspecies.get(i).gethp()+"/100");
...
//            System.out.println("Sidekick Hp:"+clonedobj_3.gethp()+"/100");
    ...
    public void buy(hero obj){
        ...
        if(in.equals("c")){
            ...
            this.clonedspecies.add(clonedobj_1);
            this.clonedspecies.add(clonedobj_2);
            this.clonedspecies.add(clonedobj_3);
            clonedobj_1.attack_value=this.attack_value;
            clonedobj_2.attack_value=this.attack_value;
            clonedobj_3.attack_value=this.attack_value;
                ...
                System.out.println("Not allowed to clone");
            }
...
class Knight extends Sidekick{
    public void buy(hero obj){
        ...
        int a=Sc.nextInt();
        this.attack_value=2+(int)(0.5*(a-5));
        obj.set_xp(obj.get_xp()-a);
